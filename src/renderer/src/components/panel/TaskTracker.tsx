              ...
              {!task.worktreeId && (
                <div className="mt-[9px] flex justify-end">
                  <button
                    ...
                    className="inline-flex size-[22px] flex-none items-center justify-center rounded-full bg-accent text-on-accent outline-none transition hover:brightness-110 focus-visible:ring-2 focus-visible:ring-accent/60"
                  >
